...
void MonteCarlo::mcVar(double &prix, double &stddev, double l, PnlRng *rng)
{
    double sum = 0.;
    double var = 0.;
    ...
    for (size_t i = 0; i < m_samples; i++) {
        ...
        m_product.asset(path, G); //asset soulle car ca passe directement des normales aux sousjacent et moi je veux les browniens du milieu
        double wT = m_product.weight_plus(path, l);
